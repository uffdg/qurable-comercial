        ...
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#2F2E35] mb-5 leading-tight">
              ...
              <br />
              <span style={{ color: ACCENT }}>genera el 90% de la rentabilidad</span>
            </h1>
            <p className="text-lg text-[#63626F] mb-8">
              En banca, retención no es una métrica de marketing: es una decisión estratégica.
              Modelado de CLV, predicción de churn y reducción de fricción digital son las tres palancas no negociables.
            </p>
